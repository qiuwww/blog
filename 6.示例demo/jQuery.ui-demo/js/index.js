$(function() {
  ...
  var page = {
    ...
    renderCompanyBlock: function(blockData) {
      ...
      // }
      html = `
    <div class="area-block hover-show" style="top:${blockData.top}px;left:${
        blockData.left
      }px;width:${blockData.width}px;height:${blockData.height}px; background-color: ${
        blockData.color
      };" data-type="" data-title="${blockData.title}"
        data-morebackground="undefined" data-height="undefined" data-width="undefined" data-color="${
          blockData.color
        }"
