...
let dom: any = document.querySelector('div');
dom.style.color = 'red';
...
// 类型断言有两种形式。
// 其一是“尖括号”语法：
let someValue110: any = 'this is a string';
let strLength110: number = (<string>someValue110).length;

// 另一个为as语法：
let someValue111: any = 'this is a string';
let strLength111: number = (someValue111 as string).length;

// 断言处理数组定义的时候，放在前面
let arr122: Array<number> = [11, 22, 33];
