...
export default class TableStore {
	...
	initTableAllData(data){
		...
		let row = data.rightTop.length;
		let col = data.leftBottom.length;
		Object.assign(this.dataLength, {col, row})
		// 使用data来计算middleWrap的宽高
		let W = row * tableConfig.cellWH.W;
		let H = col * tableConfig.cellWH.H;
		this.getMiddleWrapWH({W, H});
	}
