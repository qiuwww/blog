<template>
  ...
  >
    <div>
	  ...
	  <div style="margin-top: -42px;margin-left: 620px;">
		  <span style="margin-left: -20px; margin-top: -24px;"><Search :placeholder="placeholder" @update="handleUpdate" />
      </span>
	  </div>
		</el-col>
    ...
    >
      ...
      <el-table-column prop="option" label="操作">
        <template slot-scope="scope">
          <el-button class="theme-btn" @click="handleHistory(scope.row.id)">详情</el-button></template>
      </el-table-column>
    </el-table>
    <Pagination
