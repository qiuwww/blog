<template>
  <div>
    <el-form v-if="type !== 'info'" ref="postForm" :inline="true" :model="formData" :label-width="'100px'" :rules="rules">
      <el-form-item label="头像:" style="width: 100%" prop="headSculpture">
        <el-input v-model="formData.headSculpture" style="display: none" />
        <img :src="formData.headSculpture" style="max-width: 100px;float: left">
      ...
      <el-form-item label="性别:" prop="gender">
        <el-select v-model="formData.gender" clearable placeholder="性别" style="width: 200px">
          <el-option v-for="(item, index) in genders" :key="index" :label="item.name" :value="item.id" />
        </el-select>
      </el-form-item>
      <el-form-item label="文化程度:" prop="educationId">
        <el-select v-model="formData.educationId" clearable placeholder="文化程度" style="width: 200px" @change="educationChange">
      ...
      <el-form-item label="民族:" prop="nation">
        <el-select v-model="formData.nationId" placeholder="请选择" style="width: 200px" @change="selectNation">
      ...
      <el-form-item label="党委名称:" prop="partyCommitteeId">
        <el-select v-model="formData.partyCommitteeId" clearable placeholder="请选择" style="width: 200px" @change="selectComminttee">
      ...
      <el-form-item label="支部名称:" prop="partyBranchId">
        <el-select v-model="formData.partyBranchId" clearable placeholder="请选择" style="width: 200px" @change="selectBranch">
      ...
      <div class="text-center">
        <el-button type="primary" :loading="httpLoading" @click="postFormData">保存</el-button>
      </div>
    </el-form>
    <el-form v-else ref="postForm" :inline="true" :model="formData" :label-width="'100px'" class="infoForm">
      <el-form-item label="头像:">
        <img :src="formData.headSculpture" style="max-width: 100px">
      </el-form-item>
...
export default {
  ...
  // 选择文化程度
    ...
    // 提交表单
    postFormData() {
      this.formData.partyCategoryName = this.categoryName
      this.formData.partyCategoryId = this.categoryId
