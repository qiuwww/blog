<template>
  <div class="partyWrap">
    <div class="searchWrap">
      <div class="searchWrap">
        <el-form :inline="true" :model="searchForm" :label-width="110" size="small">
          ...
          <el-form-item label="身份证" :label-width="90">
            <el-input v-model="searchForm.idCardNo" placeholder="身份证" style="width: 178px" @keyup.enter.native="getsearchFormData" />
          </el-form-item>
          <el-form-item label="性别" :label-width="70">
            <el-select v-model="searchForm.gender" clearable placeholder="性别" style="width: 178px">
          ...
          <el-form-item label="支部名称">
            <el-select v-model="searchForm.partyBranchId" clearable placeholder="支部名称" style="width: 178px">
