<template>
	<el-row type="flex" justify="center" class="app-warp handlingFeedback">
		<el-col :span="24">
						...
						<el-table-column prop="option" label="操作">
							<template slot-scope="scope">
									...
									<el-tooltip content="查看详情" placement="top" popper-class="atooltip">
										<el-button v-if="permitIds.includes('shijian_event_details')" v-loading="loading" class="m10 btn-icon chakan"
