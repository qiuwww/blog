...
<template>
  <Modal v-model="show" :title="editTitle" :mask-closable="false" class="basicHousingManages" :draggable="false"
         width="970">
    <div style="max-height:800px;overflow-y:auto;overflow-x:hidden;" class="ModalDiv">
      <Form ref="basicHousingManageForm" :model="basicHousingManageForm">
        ...
        <Row>
          <Col span="8">
            <FormItem label="房屋分类">
              {{ basicHousingManageForm.houseClassification }}
            </FormItem>
          </Col>
          <Col span="8">
            <FormItem label="建筑性质">
              {{ basicHousingManageForm.houseNatureDescribe }}
            </FormItem>
          </Col>
          <Col span="8" v-if="basicHousingManageForm.houseNatureDescribe=='其他'">
            <FormItem label="建筑性质描述">
              {{ basicHousingManageForm.houseProperty }}
            </FormItem>
          </Col>
        </Row>
        <Row>
          ...
          <Col span="12">
            <FormItem label="房主性别">
              {{ basicHousingManageForm.hostGender }}
            </FormItem>
          </Col>
        </Row>
        <Row>
          ...
          <Col span="12">
            <FormItem label="联系方式">
              {{ basicHousingManageForm.hostContact }}
            </FormItem>
          </Col>
        </Row>
        <Row>
          <Col span="24">
            <FormItem label="房主户籍地址" style="width: 812px !important;">
              {{ basicHousingManageForm.hostPermanentAddress }}
            </FormItem>
          </Col>
        </Row>
        <Row>
          <Col span="24">
            <FormItem label="房主现住地址" style="width: 812px !important;">
              {{ basicHousingManageForm.hostCurrentAddress }}
            </FormItem>
          </Col>
        </Row>
        <Row>
        ...
        <!--        </Table>-->
        <div style="display: flex;flex-wrap: wrap;" class="personType" v-if="personData.length>0">
