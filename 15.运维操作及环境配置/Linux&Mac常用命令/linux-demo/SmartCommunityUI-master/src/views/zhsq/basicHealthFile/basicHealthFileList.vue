...
<!--</style>-->
<!--<template>-->
<!--	<div class="search" basicHealthFileList>-->
<!--		<Card>-->
...
<!--			</Row>-->
<!--			<Row class="operation">-->
<!--				<Button @click="addBasicHealthFile" type="primary" icon="md-add">新增</Button>-->
...
<!--			</Row>-->
<!--			<Row>-->
<!--				<Table :loading="loading" stripe :columns="columns" sortable="custom" :data="data" @on-sort-change="changeSort" @on-selection-change="showSelect" ref="table">-->
...
<!--			</Row>-->
<!--		</Card>-->
<!--		<updateBasicHealthFile v-model="updateShow" :BasicHealthFileId="BasicHealthFileId" :modalTitle="title" v-on:handleSearch="handleSearchPage"></updateBasicHealthFile>-->
<!--	</div>-->
<!--</template>-->
<!--<script>-->
<!--	import {deleteBasicHealthFile, queryBasicHealthFileList} from '@/api/basicHealthFile/basicHealthFile'-->
<!--	import { formartDate } from '@/api/tools/tool'-->
<!--	import updateBasicHealthFile from './updateBasicHealthFile'-->
<!--	export default {-->
<!--		components: {-->
<!--			updateBasicHealthFile-->
<!--		},-->
<!--		data() {-->
<!--			return {-->
<!--				drop: false,-->
...
<!--				search: '',-->
<!--				data: [],-->
<!--				columns: this.getBasicHealthFileColumns(),-->
...
<!--				this.BasicHealthFileId='';-->
<!--			},-->
<!--			//编辑-->
<!--			handleEdit(row, index) {-->
<!--			this.title = '编辑';-->
<!--				this.BasicHealthFileId=row.id.toString();-->
<!--				this.updateShow = true;-->
<!--			},-->
<!--			//查看-->
<!--			handleEdit(row, index) {-->
...
<!--				queryBasicHealthFileList(this.searchForm).then(res => {-->
<!--					if(res && res.success) {-->
<!--						this.loading = false;-->
...
<!--						return;-->
<!--					}-->
<!--					deleteBasicHealthFile({ids:ids}).then(res => {-->
...
<!--		mounted() {-->
<!--			this.getDataList();-->
<!--			//this.tableHeight = window.innerHeight - this.$refs.basicHealthFileTable.$el.offsetTop - 270-->
<!--		}-->
<!--	}-->
<!--</script>-->
<!--<style scoped="less">-->
