...
const list=[
  {id:0,name:"矢量图层",children:[
      {id: 0,name:'小区范围',request:'get',url:'api/basicHousingEstate/queryAllList'},
      {id: 1,name:'城市部件',request:'post',url:'api/tComponentmanagement/queryTComponentmanagementTreeByPage'},
      {id: 2,name:'网格区域',request:'get',url:'api/basicGrids/queryAllListByAnyWhere'},
