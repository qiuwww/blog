    ...
    export default {
        ...
        watch: {
            ...
            show(val) {
                ...
                this.initForm();
                if (val) {
                    if (this.TWarningSettingsId) {
                        getWarningSettingsByEquipmentId({equipmentId: this.TWarningSettingsId}).then(res => {
                            if (res && res.success) {
                                if (res.data) {
                                    this.warningSettingsForm = {
                                        id: res.data.id,
                                        equipmentId: this.TWarningSettingsId,
                                    ...
                                    this.warningSettingsForm.equipmentId = this.TWarningSettingsId;
                                }
                            }
                        });
                    }
