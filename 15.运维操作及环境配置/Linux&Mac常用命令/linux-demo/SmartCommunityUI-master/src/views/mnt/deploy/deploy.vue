<template>
  <Modal v-model="show"  :click-modal="false"  title="应用部署" width="400px">
    <Form ref="form" :model="form" :rules="rules" size="small">
      <upload
        ...
        drag
      >
<!--        《 style=" width: 369px;padding: 20px 0; border:1px dashed rgba(0,0,0,0.21);"-->
        <div>
