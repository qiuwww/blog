...
<script>
    import {queryErrorLogList} from '@/api/log/log';
    ...
    export default {
        ...
        data() {
            return {
                ...
                LogId: '',
                tableHeight: 200,
                colOptions: ["用户名", "Ip", "Ip来源", "描述", "浏览器", "创建日期", "异常详情"],
                colSelect: ["用户名", "Ip", "Ip来源", "描述", "浏览器", "创建日期", "异常详情"],
            }
        },
        methods: {
            //列表上方更多操作
            ...
            getDataList() {
                ...
                queryErrorLogList(this.searchForm).then(res => {
                    if (res && res.success) {
                        this.loading = false;
