    ...
    <Layout class="i-layout">
      ...
      <Layout class="i-layout-inside" :class="insideClasses">
        ...
        <Content class="i-layout-content" :class="contentClasses">
          ...
          <div class="i-layout-content-main" style="margin:0px!important;">
...
<script>
  ...
  import layim from './layim'
  import {showLay} from '@/settings'
  ...
  export default {
    ...
    computed: {
      ...
      menuSideWidth() {
        return this.menuCollapse ? Setting.menuCollapseWidth : Setting.menuSideWidth;
      }
    },
    watch: {
      hideSider() {
