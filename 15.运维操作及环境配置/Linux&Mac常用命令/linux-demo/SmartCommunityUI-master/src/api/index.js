...
export const getStreet = params => {
  return request({
    url:baseurl+"/gridDept/loadStreetGridDept",
    params,
    method: 'get',
  })
};
...
export const getCommunity= params => {
  return request({
    url:baseurl+"/gridDept/loadCommunityGridDeptByStreet",
    params,
    method: 'get',
  })
};
...
//获取街道社区网格树
export const loadGridDeptAndGridTree= params => {
  return request({
    url:baseurl+"/gridDept/loadGridDeptAndGridTree",
    params,
    method: 'get',
  })
};
...
//     url:baseurl+"/grid/dictionary/loadByType",
//     data:params,
//     method: 'post',
//   })
// };
export  const getDictionary= async params => {
  return getRequest(`/dictDetail/loadByType`, params)
};
// 获得全部事件
...
export const getDepartmentData = async data => {
  ...
  return await request({
    url: baseurl+"/gridDept/loadSelectByType",
    method: "post",
    data:data
  });
};
...
export const getPostData = async data => {
  return await request({
    url: baseurl+"/gridDept/post/loadAll4Select",
    method: "get",
    data
  });
};
...
//同步物业公司信息
export const initPropertyCompany = params => {
  return request({
    url:baseurl+"/community/company/initPropertyCompanyByGrid",
    data:params,
    method: 'post'
  })
};
//修改物业公司信息
export const updatePropertyCompany = params => {
  return request({
    url:baseurl+"/community/company/updatePropertyCompanyByGrid",
    params,
...
//删除物业公司信息
export const deletePropertyCompany = params => {
  return request({
    url:baseurl+"/community/company/deletePropertyCompanyByGrid",
    params,
    method: 'get',
  })
};
...
export const getEventsTypeList = async data => {
  return await request({
    url: baseurl+'/grid/events/type/loadByQuery',
    method: 'get',
    params: data
  })
}
...
// 获取所有事件类型
export const getAllEventList = async data => {
  return await request({
    url: baseurl+'/events/loadByQuery',
    method: 'post',
    data: data
  })
}
...
// 获取所有任务类型
export const getloadAllBySelect = async data => {
  return await request({
...
// 获取人群标签
export const getCrowdTags = async data => {
  // return await request({
  //   url: baseurl+'/grid/policy/userLabel/loadByQuery',
  //   method: 'get',
  //   params: data
  // })
  return await getRequest(`/dictDetail/loadByType`, {fieldName: 'tableTypeData'})
}

//批量导入模板导出
export const exportExcel = (params) => {
  return request({
    url: base + '/excel/downloadExcel', // 接口名字
    method: 'get',
    params: params,
