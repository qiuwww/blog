...
2. 稳定：性能稳定，不易崩溃。
3. 安全：提供强大的安全防护机制。
4. 多平台支持：可在多种操作系统上使用，如 Windows、Mac、Linux 等。
5. 丰富的扩展功能：用户可以通过安装扩展来增强浏览器的功能。
6. 简洁的界面：操作方便，界面简洁直观。

### 为什么开发人员都喜欢用chrome

1. 开发人员喜欢使用 Chrome 浏览器主要有以下原因：
2. 强大的开发者工具：提供了丰富而实用的调试、开发功能。
3. 兼容性好：对各种网页技术和标准的支持度高。
4. 性能优异：快速响应，提高开发效率。
5. 社区活跃：有大量的资源和讨论，便于解决问题。
6. 更新频繁：能及时跟上技术发展的脚步。
...
4. 起始页面；
5. 下载内容的下载地址；
6. 关于chrome，可以查看当前chrome的版本；
   1. caniuse：<https://caniuse.com/?search=canvas>

## 扩展程序

1. chrome://extensions/
2. 如果可以直接安装就可以到插件商店安装，不可以的就去下载安装包安装；
   1. <https://docs.authing.cn/v2/guides/asa/chrome-manual-install.html>
